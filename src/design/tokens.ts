 ...
 * Single Source of Truth for Design System Tokens
 */
...
export const tokens = {
  ...
  color: {
    surface: {
      ...
      raised: '#171717',      // cards, modals
      overlay: '#262626',     // hover, active
      sunken: '#0f0f0f',      // code blocks, inputs
    },
    text: {
      primary: '#fafafa',     // headings, body
      secondary: '#a3a3a3',   // subheads, labels
      tertiary: '#737373',    // metadata, captions
      inverse: '#0a0a0a',     // on light bg
    },
    border: {
      subtle: '#262626',
      default: '#404040',
  ...
  shadow: {
    ...
    glow: '0 0 0 1px var(--color-primary-500), 0 0 20px rgba(59, 130, 246, 0.3)',
  },
